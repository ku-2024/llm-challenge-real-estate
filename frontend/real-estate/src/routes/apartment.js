  ...
  return (
    <div className="bg-slate-100">
      ...
      <div class="ml-[18vw] px-[2%] mx-[2vw]">
        ...
        <DetailInfo id="A-env" title="환경(단지,조경)" info={info} />
        <DetailInfo id="A-community" title="커뮤니티" info={info} />
        <DetailInfo id="A-attribute" title="동별 특징" info={info} />
        <DetailInfo id="A-infra" title="주변 상권" info={info} />
        <DetailInfo id="A-traffic" title="교통" info={info} />
        <DetailInfo id="A-school" title="학군" info={info} />
        <DetailInfo id="A-sound" title="소음" info={info} />
        <DetailInfo id="A-parking" title="주차" info={info} />
      </div>
    </div>
  );
};
